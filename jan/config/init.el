...
(custom-set-variables
 ...
 '(package-selected-packages
   '(font-utils ucs-utils list-utils javadoc-lookup mark-multiple which-key ace-window expand-region smartparens smooth-scrolling doom-modeline doom-themes typescript-mode kotlin-mode go-mode rust-mode python-mode yasnippet-snippets yasnippet flycheck git-gutter magit recentf-ext multiple-cursors lsp-ui counsel-projectile company)))
